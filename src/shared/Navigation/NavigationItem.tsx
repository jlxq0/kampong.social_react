    ...
    return (
      <li key={item.id}>
        <NavLink
          ...
          className={({ isActive }) =>
            `inline-flex items-center py-1 px-2 rounded hover:text-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-200 ${
              isActive
                ? "font-semibold text-neutral-900 dark:text-neutral-200"
                : "font-normal text-neutral-6000 dark:text-neutral-300"
            }`
          }
          to={{
